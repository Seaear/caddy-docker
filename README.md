...
[![](https://img.shields.io/badge/version-0.11.4-blue.svg)](https://github.com/mholt/caddy/tree/v0.11.4)
...
### Telemetry Stats
Starting from `v0.11.4`, [Telemetry stats](https://caddyserver.com/docs/telemetry) are submitted to Caddy by default. To use Caddy without telemetry, use the `:no-stats` or `:<version>-no-stats` tags. e.g. `:0.11.4-no-stats`, `:0.11.4-php-no-stats`.
